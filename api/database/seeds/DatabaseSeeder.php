...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(App\Models\AcademicLevel::class, 20)->create();
        // factory(App\Models\Person\CategoryPerson::class, 10)->create();
...
//        factory(App\Models\Person\InstitutionPerson::class,50)->create();
        ...
        factory(App\Models\Indicator\CategoryIndicator::class,8)->create();
        factory(App\Models\Indicator\Indicator::class,10)->create();
           factory(App\Models\Indicator\IndicatorLevel::class,10)->create();
